...
export function UpdateSettings() {
  ...
  return <section className="mt-4 max-w-4xl overflow-hidden rounded-xl border border-white/8 bg-slate-950/40" aria-label="Application updates">
    <header className="flex items-center gap-3 border-b border-white/8 p-4"><RefreshCw className="size-5 text-cyan-300" /><div><h3 className="text-sm font-medium">Application updates</h3><p className="text-xs text-slate-500">Signed production releases download in the background and install when you restart.</p></div></header>
