...
Security baseline: Go 1.26.5+, Windows current-user DPAPI, authenticated loopback browser bridge, strict native-message bounds, cross-authority credential stripping, and no automatic file execution.
